...
const replCompletionAdapter = client.import('replcompletionadapter')
const fuzzyCompletionAdapter = client.import('fuzzycompletionadapter')
...
class AutoCompleteProvider {
  ...
  baselineCompletions (data, line) {
    ...
    const baselineCompletionAdapter = this.fuzzyCompletionMode ? fuzzyCompletionAdapter : replCompletionAdapter
