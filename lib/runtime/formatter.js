...
function formatEditor (editor, force = false) {
  const range = editor.getBuffer().getRange()
  return formatEditorTextInRange(editor, range, editor.getText(), force)
}

function formatEditorWithSelection (editor, selection, force = false) {
  const range = selection.getBufferRange()
  return formatEditorTextInRange(editor, range, selection.getText(), force)
}

function formatEditorTextInRange (editor, range, text, force = false) {
