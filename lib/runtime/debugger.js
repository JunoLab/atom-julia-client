...
export function consumeInk(i) {
  ...
  stepper = new ink.Stepper({
    buttons: [
      {icon: 'link-external', alt: 'Debug: Finish Function', command: 'julia-debug:finish-function'},
      {icon: 'arrow-down', alt: 'Debug: Next Line', command: 'julia-debug:step-to-next-line'},
      {icon: 'jump-down', alt: 'Debug: Step to Selected Line', command: 'julia-debug:step-to-selected-line'},
      {icon: 'triangle-right', alt: 'Debug: Next Expression', command: 'julia-debug:step-to-next-expression'},
      {icon: 'sign-in', alt: 'Debug: Step into Function', command: 'julia-debug:step-into-function'}
    ]
  })
